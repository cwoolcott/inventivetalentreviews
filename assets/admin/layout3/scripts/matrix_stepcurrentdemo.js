...
var chart = new CanvasJS.Chart("chartContainer2", 
{
    ...
    data: [{
        ...
        dataPoints: 
        [
            { tip:dp1, y: 1, x: 1.9, indexLabel: "KER", indexLabelBackgroundColor: "#ADD8E6" },
            { tip:dp2, y: 2.0, x: 2.7, indexLabel: "JGJ",  indexLabelBackgroundColor: "#90EE90"  },
            { tip:dp3, y: 1, x: 2.1, indexLabel: "PRM",  indexLabelBackgroundColor: "#ADD8E6"  },
            { tip:dp4, y: 1.4, x: 2.1, indexLabel: "SMB",  indexLabelBackgroundColor: "#FFE4E1"  },
            ...
            /*  { tip:dp6, y: 0.4, x: 1.5, indexLabel: "MLL", markerSize:1 },
            { tip:dp6, y: 0.4, x: 1.5, indexLabel: "MLL", markerSize:1 },
            { tip:dp6, y: 0.4, x: 1.5, indexLabel: "MLL", markerSize:1 }, */
        ]
    },
